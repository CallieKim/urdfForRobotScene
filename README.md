...
\urdfForRobotScene
  ...
  \robot_name (make this folder before you start!)
      \robot_description\all_robots.urdf (You should have it in this directory when you run mesh_lookup_populator.py, You may simply paste the entire robot's folder, the script walks through all folders for you)
